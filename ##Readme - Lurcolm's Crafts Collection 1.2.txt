INSTALLATION:
Create a seperate folder to store the mod in (Optional but Highly Recommended)
Unzip the mod
Unzip the Truetile folder

Rename your diy_glossary and biy_glossary to ORIGINAL- biy/diy glossary.

Mass copy and paste the files to your game directory

**VERY IMPORTANT**

Have some fucking fun :3
...
CHANGELOG 1.2:
- Reworked.... a lot. Made a lot of items more skill based, changed a lot of skills, etc

- I added a wooden fishhook, cuz I figured there's a need for something like that

-I actually started modding this again. So yeah.
